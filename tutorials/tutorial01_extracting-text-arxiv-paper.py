...
def _(mo):
    ...
    Amongst the fields of `ArxivPaper`, there is `text`. This is empty for now, but in the next section [2. Extracting and cleaning text from PDFs](#extracting-and-cleaning-text-from-pdfs) will be populated.
    """
    )
    return
